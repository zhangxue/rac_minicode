...
steps_for(:ra_resource) do
  ...
  #   "Given a hr with login: 'mojojojo'" 
  # produces a Hr instance stored in @hr with 'mojojojo' as its login
  # attribute.
  #
  ...
  #   "And the hr has thac0: 3"
  # takes the earlier-defined @hr instance and sets its thac0 to '3'.
  #
...
#
# So, for instance,
#   klass, instance = parse_resource_args 'hr'
#   instance = klass.new({login => 'me', password => 'monkey', ...})
#   keep_instance! resource, instance
# keeps the just-constructed Hr model in the @hr instance variable.
#
