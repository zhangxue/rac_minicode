...
Story: Creating an account
  ...
  #
  Scenario: Anonymous hr can start creating an account
    Given an anonymous hr
    When  she goes to /signup
    Then  she should be at the 'hrs/new' page
  ...
  # Account Creation
  #
  Scenario: Anonymous hr can create an account
    Given an anonymous hr
     And  no hr with login: 'Oona' exists
    ...
    Then  she should see a notice message 'Thanks for signing up!'
     And  a hr with login: 'oona' should exist
     And  the hr should have login: 'oona', and email: 'unactivated@example.com'
  ...
  Scenario: Anonymous hr can not create an account replacing an activated account
    Given an anonymous hr
     And  an activated hr named 'Reggie'
     And  we try hard to remember the hr's updated_at, and created_at
    ...
    Then  she should be at the 'hrs/new' page
     ...
     And  a hr with login: 'reggie' should exist
     And  the hr should have email: 'registered@example.com'

     And  the hr's created_at should stay the same under to_s
     And  the hr's updated_at should stay the same under to_s
     And  she should not be logged in

  #
  # Account Creation Failure: Incomplete input
  #
  Scenario: Anonymous hr can not create an account with incomplete or incorrect input
    Given an anonymous hr
     And  no hr with login: 'Oona' exists
    ...
    Then  she should be at the 'hrs/new' page
     ...
     And  no hr with login: 'oona' should exist
     
  Scenario: Anonymous hr can not create an account with no password
    Given an anonymous hr
     And  no hr with login: 'Oona' exists
  ...
  Scenario: Anonymous hr can not create an account with no password_confirmation
    Given an anonymous hr
     And  no hr with login: 'Oona' exists
  ...
  Scenario: Anonymous hr can not create an account with mismatched password & password_confirmation
    Given an anonymous hr
     And  no hr with login: 'Oona' exists
  ...
  Scenario: Anonymous hr can not create an account with bad email
    Given an anonymous hr
     And  no hr with login: 'Oona' exists
