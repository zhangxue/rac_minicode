...
Story: Logging in
  As an anonymous hr with an account
  ...
  # Log in: get form
  #
  Scenario: Anonymous hr can get a login form.
  ...
  #
  Scenario: Anonymous hr can log in
    Given an anonymous hr
  ...
  Scenario: Logged-in hr who logs in should be the new one
    Given an activated hr named 'reggie'
     And  an activated hr logged in as 'oona'
    When  she creates a singular sessions with login: 'reggie', password: 'monkey', remember me: ''
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'Logged in successfully'
  ...
  #
  Scenario: Anonymous hr can log in and be remembered
    Given an anonymous hr
     And  an activated hr named 'reggie'
    ...
    Then  she should see a notice message 'Logged in successfully'
     ...
     And  her session store should have hr_id: 4
   
  #
  # Log in unsuccessfully
  #
  
  Scenario: Logged-in hr who fails logs in should be logged out
    Given an activated hr named 'oona'
    ...
    Then  she should see an error message 'Couldn't log you in as 'reggie''
     ...
     And  she should not have an auth_token cookie
     And  her session store should not have hr_id
  ...
  #
  Scenario: Anonymous (logged out) hr can log out.
    Given an anonymous hr
  ...
  Scenario: Logged in hr can log out.
    Given an activated hr logged in as 'reggie'
    When  she goes to /logout
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'You have been logged out'
